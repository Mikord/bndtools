...
public class About {
	...
	public static Version       _3_3_305 = new Version(3, 3, 305);
	public static Version				CURRENT		= _3_3_305;
	...
	public static String[]				CHANGES_3_1	= {
															...
															"Added FileSet to libg", "Stand alone bdnrun files",
	...
	public static String[]				CHANGES_3_0	= {
															...
															"Properly handles optionals in resolve",
	...
	public static String[]				CHANGES_2_4	= {
															...
															"Support for Gradle plugin", "Support Travis builds",
	...
	public static String[]				CHANGES_2_3	= {
															...
															"Verify that the " + Constants.META_PERSISTENCE
																	+ " header's locations actually exist",
															...
															"Implemented the {Processor.since() functionality with the "
																	+ Constants.UPTO + " instruction.",
